...
def get_boards(session: DBSession, account: OptionalAccount = None) -> BoardCollection:
...
def get_editable_boards(session: DBSession, account: CurrentAccount) -> BoardCollection:
...
def create_board(session: DBSession, account: CurrentAccount, config: BoardCreate) -> DBBoard:
...
def get_board(session: DBSession, board_id: int, account: OptionalAccount = None) -> DBBoard:
...
def update_board(session: DBSession, board_id: int, account: CurrentAccount, config: BoardUpdate) -> DBBoard:
...
def delete_board(session: DBSession, board_id: int, account: CurrentAccount) -> None:
...
def get_editors(session: DBSession, board_id: int, account: CurrentAccount) -> AccountCollection:
...
def add_editor(session: DBSession, board_id: int, editor_id: int, account: CurrentAccount) -> AccountCollection:
...
def remove_editor(session: DBSession, board_id: int, editor_id: int, account: CurrentAccount) -> AccountCollection:
